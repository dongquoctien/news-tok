...
export default function HomePage() {
  return (
    <main className="flex min-h-screen flex-col">
      <header className="flex items-center justify-end gap-1 border-b px-6 py-3">
        <ThemeToggle />
      ...
      <section className="flex flex-1 flex-col items-center justify-center gap-6 px-6 py-12 text-center">
        <div className="inline-flex items-center gap-4 text-5xl font-semibold tracking-tight">
          <Clapperboard
            aria-hidden
