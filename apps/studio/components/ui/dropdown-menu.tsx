...
/**
 * Shadcn-style DropdownMenu wrapper around Radix `react-dropdown-menu`.
 * Used for **action menus** (commands attached to a trigger, no
 * persistent value), whereas `Select` is for **value pickers**. The
 * editor's split-button "Render variant X" picker is the canonical
 * example.
 *
 * Subset surfaced: Root, Trigger, Content, Item, Separator, Label.
 */
